            ...
            <form action="{{route('employee.store')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-md-4 col-xl-3">
                        ...
                        <input type="text" name="unique_id" value="{{ $employee->unique_id ?? old('unique_id') }}" class="form-control @error('u_id') is-invalid @enderror" placeholder="Employee Unique ID">
                        @error('unique_id')
                            <div class="text-danger">{{ "* ".$message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-sm-6 col-md-4 col-xl-3">
                        ...
                        <input type="text" name="name" value="{{ $employee->name ?? old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Employee Name">
                        @error('name')
                            <div class="text-danger">{{ "* ".$message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-sm-6 col-md-4 col-xl-3">
                        ...
                        <input type="email" name="email" value="{{ $employee->email ?? old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="Email">
                        @error('email')
                            <div class="text-danger">{{ "* ".$message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-sm-6 col-md-4 col-xl-3">
                        ...
                        <input type="text" name="username" value="{{ $employee->username ?? old('username') }}" class="form-control @error('username') is-invalid @enderror" placeholder="Username">
                        @error('username')
                            <div class="text-danger">{{ "* ".$message }}</div>
                        @enderror
                    </div>
    ...
    <script>
        ;(function($){
            $(document).ready(function(){
                ...
                $("#role option[value={{$employee->role_id}}]").attr("selected", "");
            });
        })(jQuery);
    </script>
@endpush