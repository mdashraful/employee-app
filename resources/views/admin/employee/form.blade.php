...
<div class="form-group col-sm-6 col-md-4 col-xl-3">
    ...
    <input type="text" id="join_date" name="join_date" value="{{ $employee->join_date ?? old('join_date') }}" class="form-control @error('u_id') is-invalid @enderror" placeholder="Join Date">
    @error('join_date')
        <div class="text-danger">{{ "* ".$message }}</div>
    @enderror
</div>
