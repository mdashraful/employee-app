...
<div class="form-group col-sm-6 col-md-4 col-xl-3">
    ...
    <input type="number" name="leave_days" min="0" value="{{ $leave_category->leave_days != '' ? $leave_category->leave_days : old('leave_days')}}" class="form-control @error('leave_days') is-invalid @enderror" placeholder="Total Days">
    @error('leave_days')
        <div class="text-danger">{{ "* ".$message }}</div>
    @enderror
</div>
